			...
			<>
				...
				<Wrapper onClick={this.exit}>
					<WorkElement>
						...
						<Link to='/'>
							<WorkImage src={wow} title="Przejdź do aplikacji" alt=""/>
						</Link>
						<WorkDescription>Taka strona nie istnieje! Ale jak już jesteś, to wpadnij na moje Social Media: </WorkDescription>
						<SocialMediaWrapper>
